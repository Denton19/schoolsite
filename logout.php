...
<body>
  ...
  <a class="navbar-brand" href="header.php"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav mr-auto">
      ...
      <a class=" nav-link" href="students.php">View Attendees</a>
    </div>
    <div class="navbar-nav ml-auto">
      ...
      <a class="nav-item nav-link active" href="login.php">Logout <span class="sr-only">(current)</span></a>
          ...
          href="sessionends.php">Logout <span class="sr-only">(current)</span></a>     
         <?php }?>
    </div>
  </div>
</nav>
